...
public class Monster : Actor
{
    ...
    // 몬스터 생성
    public Monster(string name, int level, int maxhp, int atk, int def, int spd, int exp, Dictionary<int, int> spawnRates, Dictionary<string, int> dropTable)
    {
        Name = name;
        Level = level;
        MaxHP = maxhp;
    ...
    {
        new Monster("달팽이", 1, 10, 2, 0, 1, 1, new Dictionary<int, int> { {1, 50}, {2, 40}, {3, 0},  {4, 0}  }), new Dictionary<string, int> { {"포션", 30}, {"강화석", 30} }
        new Monster("고블린", 3, 25, 5, 0, 1, 2, new Dictionary<int, int> { {1, 50}, {2, 40}, {3, 50}, {4, 0}  }), new Dictionary<string, int> { {"포션", 40}, {"강화석", 35} }
        new Monster("오크", 5, 50, 2, 2, 3, 5, new Dictionary<int, int> { {1, 0},  {2, 20}, {3, 50}, {4, 60} }),  new Dictionary<string, int> { {"포션", 50}, {"하이포션", 20}, {"강화석", 40} }
        new Monster("골렘", 10, 200, 10, 5, 2, 8, new Dictionary<int, int> { {1, 0},  {2, 0},  {3, 0},  {4, 40} }), new Dictionary<string, int> { {"하이포션", 35}, {"강화석", 50} }
    };
